...
const priceReductionFactor = 0.7; // 30% reduction
...
export const cars: Car[] = [
  {
    ...
    make: 'Maruti Suzuki',
    model: 'Swift',
    year: currentYear - 3, // 2022 -> 2021 (approx 3 years old)
    price: Math.round(750000 * priceReductionFactor), // Original approx 7.5 Lakhs
  ...
  },
  {
    ...
    make: 'Hyundai',
    model: 'Creta',
    year: currentYear - 2, // 2022 -> 2022 (approx 2 years old)
    price: Math.round(1500000 * priceReductionFactor), // Original approx 15 Lakhs
  ...
  },
  {
    ...
    make: 'Kia',
    model: 'Seltos',
    year: currentYear - 1, // 2023 -> 2023 (approx 1 year old)
    price: Math.round(1650000 * priceReductionFactor), // Original approx 16.5 Lakhs
  ...
  },
  {
    ...
    make: 'Tata',
    model: 'Nexon EV',
    year: currentYear - 2, // 2022 -> 2022
    price: Math.round(1700000 * priceReductionFactor), // Original approx 17 Lakhs
  ...
  },
  {
    ...
    model: 'XUV700',
    year: currentYear - 2, // 2022 -> 2022
    price: Math.round(2200000 * priceReductionFactor), // Original approx 22 Lakhs
  ...
  },
  {
    ...
    make: 'Toyota',
    model: 'Innova Crysta',
    year: currentYear - 3, // 2021 -> 2021
    price: Math.round(2400000 * priceReductionFactor), // Original approx 24 Lakhs
  ...
  },
   {
    ...
    model: 'City',
    year: currentYear - 2, // 2022 -> 2022
    price: Math.round(1400000 * priceReductionFactor), // Original approx 14 Lakhs
  ...
  },
  {
    ...
    make: 'Volkswagen',
    model: 'Virtus',
    year: currentYear - 1, // 2023 -> 2023
    price: Math.round(1550000 * priceReductionFactor), // Original approx 15.5 Lakhs
  ...
  },
  {
    ...
    model: 'Kushaq',
    year: currentYear - 2, // 2022 -> 2022
    price: Math.round(1600000 * priceReductionFactor), // Original approx 16 Lakhs
  ...
  },
  {
    ...
    model: 'Kiger',
    year: currentYear - 2, // 2022 -> 2022
    price: Math.round(850000 * priceReductionFactor), // Original approx 8.5 Lakhs
  ...
  // Adding New Cars
  {
    ...
    model: 'Punch EV',
    year: currentYear,
    price: Math.round(1100000 * priceReductionFactor), // New car price, approx 11 Lakhs
  ...
  },
  {
    ...
    model: 'Fronx',
    year: currentYear,
    price: Math.round(950000 * priceReductionFactor), // New car price, approx 9.5 Lakhs
  ...
  },
  {
    ...
    model: 'Exter',
    year: currentYear,
    price: Math.round(700000 * priceReductionFactor), // New car price, approx 7 Lakhs
