...
import { Lightbulb, Users, CheckCircle, Search, ArrowRight } from 'lucide-react';
...
export default function HomePage() {
  ...
  const features = [
    {
      icon: <Lightbulb className="h-12 w-12 text-accent mb-4" />,
    ...
    {
      icon: <Search className="h-12 w-12 text-accent mb-4" />, // Changed from Users
      title: "Vast Selection",
      description: "Explore a wide variety of makes and models, from fuel-efficient sedans to rugged SUVs and luxury vehicles.",
    },
    {
      icon: <CheckCircle className="h-12 w-12 text-accent mb-4" />,
  ...
  return (
    <>
      <HeroSection
        ...
        ctaLink="/gallery"
        imageUrl="https://picsum.photos/seed/luxury-car-dealership/1920/1080" // More specific seed
        imageHint="luxury car dealership"
      />

      <section className="py-16 md:py-24 bg-background"> {/* Changed to background for contrast */}
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            {features.map((feature, index) => (
              <Card key={index} className="text-center shadow-lg hover:shadow-xl transition-shadow duration-300 bg-card border border-border rounded-xl p-6">
                <CardHeader className="pb-4 pt-2">
                  <div className="flex justify-center">{feature.icon}</div>
                  <CardTitle className="text-2xl font-semibold text-primary mt-2">{feature.title}</CardTitle>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-16 md:py-24 bg-secondary"> {/* Changed to secondary for section separation */}
        <div className="container mx-auto px-4">
          <SectionTitle
            title="Featured Cars"
          ...
          <div className="mt-12 text-center">
            <Link href="/gallery" passHref>
              <Button size="lg" variant="outline" className="border-primary text-primary hover:bg-primary/10 hover:text-primary-foreground text-md px-8 py-3 shadow-sm">
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/ai-finder" passHref>
            <Button size="lg" variant="secondary" className="bg-accent hover:bg-accent/90 text-accent-foreground text-md px-10 py-3 shadow-lg">
