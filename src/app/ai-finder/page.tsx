...
export default function AiFinderPage() {
  ...
  const { register, handleSubmit, control, formState: { errors } } = useForm<AIFinderFormData>({
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        ...
        <div className="mt-8 md:mt-0">
          ...
          {!isLoading && results && (
            <Card className="shadow-xl bg-card border-accent">
              <CardHeader>
                <CardTitle className="text-2xl font-semibold text-primary flex items-center gap-2">
                   <CarIcon className="w-6 h-6" />
                  AI Recommendations
           ...
           {!isLoading && !results && (
             <Card className="shadow-xl h-full flex flex-col items-center justify-center text-center bg-secondary/50">
...
// Helper component for Select with react-hook-form Controller
